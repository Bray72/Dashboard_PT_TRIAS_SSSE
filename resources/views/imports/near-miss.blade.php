...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-orange-900">Import Near Miss Reports</h1>
        <p class="text-gray-600 mt-2">Bulk import near miss incident data from CSV file</p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- Import Form -->
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg p-6 mb-8 border border-orange-600 shadow-lg">
                <form id="importForm" method="POST" action="{{ route('import.near-miss.process') }}" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Company *</label>
                        <select name="company_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500">
                    ...
                    <div class="flex gap-2">
                        <button type="submit" class="flex-1 bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-semibold transition">
                        ...
                        <a href="{{ route('import.near-miss.sample') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:col-span-1">
            <div class="bg-orange-50 rounded-lg p-6 border border-orange-200">
                <h3 class="text-lg font-semibold text-orange-900 mb-4">CSV Format Requirements</h3>
                
                <div class="space-y-4 text-sm">
                    <div>
                        <p class="font-semibold text-orange-900 mb-2">Required Columns:</p>
                    ...
                    <div>
                        <p class="font-semibold text-orange-900 mb-2">Valid Values:</p>
                        <ul class="text-gray-700 space-y-1 text-xs">
                            <li><strong>Category:</strong> Unsafe Act, Unsafe Condition</li>
                    ...
                    <div>
                        <p class="font-semibold text-orange-900 mb-2">Departments:</p>
                        <ul class="text-gray-700 space-y-1 text-xs">
                            @foreach($departments as $dept)
                                <li><strong>{{ $dept->id }}:</strong> {{ $dept->name }}</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="bg-white p-3 rounded border border-orange-100">
                        ...
                        <p class="text-gray-600 text-xs font-mono">
                            2024-01-15, Workshop, 1, Unsafe Act, Medium, High, Sample incident, Open
                        </p>
                    </div>

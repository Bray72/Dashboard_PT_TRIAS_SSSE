...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-blue-900">Import Safety Metrics</h1>
        <p class="text-gray-600 mt-2">Bulk import safety metrics data from CSV file</p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- Import Form -->
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg p-6 mb-8 border border-blue-600 shadow-lg">
                <form id="importForm" method="POST" action="{{ route('import.safety-metrics.process') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('import.safety-metrics.sample') }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:col-span-1">
            <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h3 class="text-lg font-semibold text-blue-900 mb-4">CSV Format Requirements</h3>
                
                <div class="space-y-4 text-sm">
                    <div>
                        <p class="font-semibold text-blue-900 mb-2">Required Columns:</p>
